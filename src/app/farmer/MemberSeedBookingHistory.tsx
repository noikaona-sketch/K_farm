...
type Booking = { id: string; booking_no: string; booking_date: string; receive_date: string; pickup_date?: string; pickup_time?: string; pickup_location_name?: string; total_amount: number; deposit_amount: number; status: string }

...
export default function AdminSeedBooking() {
  ...
  <div className="flex gap-2 justify-center">
    ...
    <button
      type="button"
      disabled={saving || b.status === 'converted'}
      onClick={() => void convertToPOS(b)}
      className="inline-flex items-center gap-1 px-3 py-1.5 rounded-lg bg-emerald-600 text-white text-xs font-semibold disabled:bg-gray-300"
    >

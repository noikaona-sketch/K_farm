  ...
  return (
    <div className="max-w-3xl mx-auto">
      <div className="flex items-center gap-3 mb-6">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Import สมาชิกเก่า Excel</h1>
          <p className="text-gray-500 text-sm mt-0.5">จัดการข้อมูล Import สมาชิกเก่า Excel</p>
        </div>
      </div>
